...
public class InscriptionTransferQueryTests : InscriptionIndexerTestBase
{
    ...
    public async Task Test()
    {
        ...
        await Query.InscriptionTransfer(TransferRepository, InscriptionRepository, ObjectMapper, new GetInscriptionTransferInput()
        {
            ChainId = ChainId,
            SkipCount = 0,
            MaxResultCount = 1001
        ...
        var list = await Query.InscriptionTransfer(TransferRepository, InscriptionRepository, ObjectMapper, new GetInscriptionTransferInput()
        {
            ChainId = ChainId,
        });
