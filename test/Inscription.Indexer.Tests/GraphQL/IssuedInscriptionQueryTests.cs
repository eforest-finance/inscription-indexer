...
public class IssuedInscriptionQueryTests : InscriptionIndexerTestBase
{
    ...
    public async Task Test()
    {
        ...
        await Query.IssuedInscription(IssuedInscriptionRepository, InscriptionRepository, InscriptionOptions,
        ...
        var list = await Query.IssuedInscription(IssuedInscriptionRepository, InscriptionRepository, InscriptionOptions,
            ObjectMapper, new GetIssuedInscriptionInput()
            {
                ChainId = ChainId,
                Tick = "Tick1"
        ...
        list = await Query.IssuedInscription(IssuedInscriptionRepository, InscriptionRepository, InscriptionOptions,
            ObjectMapper, new GetIssuedInscriptionInput()
            {
                ChainId = ChainId,
            });
